...
export const createBattleState: (a: number, b: number) => void;
export const createCreature: (a: number, b: number, c: number, d: number) => void;
...
export const stepBattle: (a: number, b: number, c: number, d: number) => void;
