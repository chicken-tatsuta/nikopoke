...
const VEGA_ITERATIVE_MAX_DEPTH = 10;
const VEGA_ITERATIVE_NODE_BUDGET = 500_000;
const VEGA_PONDERING_NODE_BUDGET = 2_000_000;
const VEGA_PRECOMPUTE_MAX_WAIT_MS = 5000;
